...
# 关于本站 
SomeFreakingAnime是一个<em><del>小孩子不懂事写着玩的</del></em>致力于分享在线番剧播放资源的索引站。
### 网站基于以下开源项目构建:
...
[又拍云](https://www.upyun.com/) [OneDrive](https://onedrive.live.com) <del>[小麦云服](localhost)</del> <del>[存储猫](https://www.miaofile.com/)</del> 提供资源托管服务
